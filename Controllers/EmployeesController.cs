...
namespace Employee_Challange.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EmployeesController : ControllerBase
    {
        private readonly Employee_ChallangeContext _context;

        public EmployeesController(Employee_ChallangeContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Employees>> PostEmployees(Employees employees)
        {
          if (_context.Employees == null)
          {
              return Problem("Entity set 'Employee_ChallangeContext.Employees'  is null.");
          }
